...
export default () => {
  ...
  const onPasswordSubmit = handleSubmit(({ nowPassword, newPassword, confirmPassword }) => {
  ...
  return (
    <div>
      ...
      <p>{user.displayName} {!nameOpen && <Button variant="contained" color="primary" onClick={onNameClick}>変更する</Button>}</p>
      {nameOpen && 
        <form onSubmit={onNameSubmit}>
          <input name="userName" ref={register} />
          <Button type="submit" variant="contained" color="primary">変更する</Button>
        </form>
      }
      <p>{user.email} {!emailOpen && <Button variant="contained" color="primary" onClick={onEmailClick}>変更する</Button>}</p>
      {emailOpen && 
      ...
      <Link href="#" color="inherit" onClick={onPasswordClick}>パスワードを変更する</Link>
      {passwordOpen && 
